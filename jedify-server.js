...
function buildDefaultTemplate() {
  return {
    ...
    slides: [
      ...
      { title: 'KPI Gaps',            description: 'Full-width table: KPI | Our Value | Top 3 Avg (Market) | Gap % | Possible Reasons. Gap column shows red percentage for negative gaps, green for positive. Possible Reasons column has 1-2 sentence explanations inline. Below the table: a row of 4 summary score cards, one per KPI. Each card: metric label in small caps, large bold gap % (red if negative, green if positive), short "Fix:" note in small grey text below. If a metric is a positive outlier (e.g. above competitors), give it a green border and green text.' },
